        ...
        <div className="wrapper d-grid gap-20">
          ...
          <div className="welcome bg-white rad-10 txt-c-mobile block-mobile">
            <div className="intro p-20 d-flex space-between bg-eee">
              <div>
                ...
                <p className="c-grey mt-5">Khaled</p>
              </div>
              <img className="hide-mobile" src="/images/welcome.png" alt="" />
            </div>
            ...
            <ul className="m-0">
              <li className="between-flex pb-10 mb-10">
                <div className="d-flex align-center">
                  <img className="mr-10" src="/images/pdf.svg" alt="" />
                  <div>
                    <span className="d-block">my-file.pdf</span>
                    <span className="fs-15 c-grey">Yoru</span>
                  </div>
                </div>
              ...
              <li className="between-flex pb-10 mb-10">
                <div className="d-flex align-center">
                  <img className="mr-10" src="/images/avi.svg" alt="" />
                  <div>
              ...
              <li className="between-flex pb-10 mb-10">
                <div className="d-flex align-center">
                  <img className="mr-10" src="/images/psd.svg" alt="" />
                  <div>
                    <span className="d-block">My-Psd-File.pdf</span>
                    <span className="fs-15 c-grey">Khaled</span>
                  </div>
                </div>
              ...
              <li className="between-flex pb-10 mb-10">
                <div className="d-flex align-center">
                  <img className="mr-10" src="/images/zip.svg" alt="" />
                  <div>
              ...
              <li className="between-flex pb-10 mb-10">
                <div className="d-flex align-center">
                  <img className="mr-10" src="/images/dll.svg" alt="" />
                  <div>
              ...
              <li className="between-flex">
                <div className="d-flex align-center">
                  <img className="mr-10" src="/images/eps.svg" alt="" />
                  <div>
          ...
          <div className="latest-post p-20 bg-white rad-10 p-relative">
            ...
            <div className="top d-flex align-center">
              <img className="avatar mr-15" src="/images/avatar.png" alt="" />
              <div className="info">
                <span className="d-block mb-5 fw-bold">Khaled Sherif</span>
                <span className="c-grey">About 3 Hours Ago</span>
              </div>
            </div>
            <div className="post-content txt-c-mobile pt-20 pb-20 mt-20 mb-20">
              You can fool all of the people some of the time, and some of the
              people all of the time, but you cant fool all of the people all of
              the time.
            </div>
