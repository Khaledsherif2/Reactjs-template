          ...
          <div className="files-content d-grid gap-20">
            <div className="file bg-white p-10 rad-10">
              ...
              <div className="icon txt-c">
                <img className="mt-15 mb-15" src="/images/pdf.svg" alt="" />
              </div>
              <div className="txt-c mb-10 fs-14">my-file.pdf</div>
              <p className="c-grey fs-13">Yoru</p>
            ...
            <div className="file bg-white p-10 rad-10">
              <i className="fa-solid fa-download c-grey p-absolute"></i>
              <div className="icon txt-c">
                <img className="mt-15 mb-15" src="/images/avi.svg" alt="" />
              </div>
            ...
            <div className="file bg-white p-10 rad-10">
              <i className="fa-solid fa-download c-grey p-absolute"></i>
              <div className="icon txt-c">
                <img className="mt-15 mb-15" src="/images/eps.svg" alt="" />
              </div>
            ...
            <div className="file bg-white p-10 rad-10">
              <i className="fa-solid fa-download c-grey p-absolute"></i>
              <div className="icon txt-c">
                <img className="mt-15 mb-15" src="/images/psd.svg" alt="" />
              </div>
              <div className="txt-c mb-10 fs-14">my-file.psd</div>
              <p className="c-grey fs-13">Khaled</p>
              <div className="info between-flex mt-10 pt-10 fs-13 c-grey">
                <span>16/5/2021</span>
                <span>15.1MB</span>
              </div>
            ...
            <div className="file bg-white p-10 rad-10">
              <i className="fa-solid fa-download c-grey p-absolute"></i>
              <div className="icon txt-c">
                <img className="mt-15 mb-15" src="/images/dll.svg" alt="" />
              </div>
            ...
            <div className="file bg-white p-10 rad-10">
              <i className="fa-solid fa-download c-grey p-absolute"></i>
              <div className="icon txt-c">
                <img className="mt-15 mb-15" src="/images/png.svg" alt="" />
              </div>
